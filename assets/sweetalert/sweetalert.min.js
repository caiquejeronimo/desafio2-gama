! function (t, e) {
    ...
    function Se(t) {
        ...
        Me(e, n, t), setTimeout(function () {
            qe(e, n)
        }, 10), N() && (je(e, t.scrollbarPadding, o), h(document.body.children).forEach(function (t) {
            t === C() || function (t, e) {
        ...
        })), X() || oe.previousActiveElement || (oe.previousActiveElement = document.activeElement), Ie(n, t), vt(e, $["no-transition"])
    }
    ...
    var Ie = function (t, e) {
        ...
        qe = function (t, e) {
            Bt && ut(e) ? (t.style.overflowY = "hidden", e.addEventListener(Bt, Te)) : t.style.overflowY = "auto"
        },
        je = function (t, e, n) {
            var o;
        ...
        ze = function (t, e, n) {
            ...
            e.inputValidator ? We(t, e, o) : t.getInput().checkValidity() ? "deny" === n ? Ke(t, o) : Ye(t, e, o) : (t.enableButtons(), t.showValidationMessage(e.validationMessage))
        },
        We = function (e, n, o) {
        ...
        tn = function (t) {
            -1 !== [T(), L(), I()].indexOf(document.activeElement) && (t = -1 !== Ze.indexOf(t) ? "nextElementSibling" : "previousElementSibling", (t = document.activeElement[t]) && t.focus())
        },
        en = function (t, e, n) {
    ...
    function un(a, s, c) {
        return new Promise(function (t) {
            ...
            var n, o, i, r;
            ge.swalPromiseResolve.set(a, t), s.confirmButton.onclick = function () {
                return e = c, (t = a).disableButtons(), void(e.input ? ze(t, e, "confirm") : Ye(t, e, !0));
                var t, e
            }, s.denyButton.onclick = function () {
                return e = c, (t = a).disableButtons(), void(e.returnInputValueOnDeny ? ze(t, e, "deny") : Ke(t, !1));
                var t, e
                ...
                return e(Z.close)
            }, n = a, r = s, t = e, St.innerParams.get(n).toast ? nn(n, r, t) : (rn(r), an(r), sn(n, r, t)), o = a, r = c, i = e, (t = oe).keydownTarget && t.keydownHandlerAdded && (t.keydownTarget.removeEventListener("keydown", t.keydownHandler, {
                ...
                capture: t.keydownListenerCapture
            }), t.keydownHandlerAdded = !0), (c.toast && (c.input || c.footer || c.showCloseButton) ? gt : vt)(document.body, $["toast-column"]), r = a, "select" === (t = c).input || "radio" === t.input ? Ne(r, t) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(t.input) && (v(t.inputValue) || b(t.inputValue)) && Ue(r, t), Se(c), dn(oe, c, e), pn(s, c), setTimeout(function () {
    ...
    var dn = function (t, e, n) {
            var o = V();
            rt(o), e.timer && (t.timeout = new Pe(function () {
    ...
    var vn, yn = function (t) {
        ...
        Q = Object.freeze({
            ...
            _main: function (t) {
                ...
                var e = cn(t);
                return Oe(e), Object.freeze(e), oe.timeout && (oe.timeout.stop(), delete oe.timeout), clearTimeout(oe.restoreFocusTimeout), t = ln(this), Nt(this, e), St.innerParams.set(this, e), un(this, t, e)
            },
            update: function (e) {
                var t = x(),
                    n = St.innerParams.get(this);
                ...
                Object.keys(e).forEach(function (t) {
                    wn.isUpdatableParameter(t) ? o[t] = e[t] : z('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js\n\nIf you think this parameter should be updatable, request it here: https://github.com/sweetalert2/sweetalert2/issues/new?template=02_feature_request.md'))
    ...
    c(bn.prototype, Q), c(bn, ce), Object.keys(Q).forEach(function (t) {
        bn[t] = function () {
            if (vn) return vn[t].apply(vn, arguments)
        }
    }), bn.DismissReason = Z, bn.version = "10.7.0";
    var wn = bn;
